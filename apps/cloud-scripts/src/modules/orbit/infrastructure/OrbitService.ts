...
@Injectable()
export class OrbitService extends IOrbitService {
  constructor(
  ...
  async updateDynamicDNS(id, address, type, apiKey) {
  ...
  async batchUpdateDynamicDNS(portals, ip) {
  ...
  async updateCloudflareDNS(apiToken, domain, ip, options: any = {}) {
  ...
  async generateNginxConfig(portal, forceTransponder = null) {
