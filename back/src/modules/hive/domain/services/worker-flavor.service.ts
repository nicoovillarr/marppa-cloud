...
export class WorkerFlavorService {
  ...
  async createWorkerFlavor(data: CreateWorkerFlavorDto): Promise<WorkerFlavorEntity> {
  ...
  async updateWorkerFlavor(id: number, data: UpdateWorkerFlavorDto): Promise<WorkerFlavorEntity> {
