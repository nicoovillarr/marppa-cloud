...
import { NodeRepository, NODE_REPOSITORY_SYMBOL } from '../repositories/node.repository';
...
describe('NodeService', () => {
    ...
    describe('findById', () => {
        ...
        it('should throw NotFoundError if node not found', async () => {
            ...
            await expect(service.findById('z-000001', 'n-999999')).rejects.toThrow(NotFoundError);
        });
    });
    ...
    describe('create', () => {
        ...
        it('should throw UnauthorizedError if no user in session', async () => {
            ...
            expect(() => service.create('z-000001', createDto, ipAddress)).toThrow(UnauthorizedError);
        });
        ...
        it('should throw Error if neither workerId nor atomId is provided', async () => {
            ...
            expect(() => service.create('z-000001', invalidDto, ipAddress)).toThrow("Worker ID or Atom ID must be provided");
        });
        ...
        it('should throw Error if both workerId and atomId are provided', async () => {
            ...
            expect(() => service.create('z-000001', invalidDto, ipAddress)).toThrow("Worker ID and Atom ID cannot be provided together");
        });
    });
