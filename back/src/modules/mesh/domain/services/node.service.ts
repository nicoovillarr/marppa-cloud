...
import { NODE_REPOSITORY_SYMBOL, NodeRepository } from "../repositories/node.repository";
...
export class NodeService {
  ...
  public create(zoneId: string, data: CreateNodeDto, ipAddress: string): Promise<NodeEntity> {
