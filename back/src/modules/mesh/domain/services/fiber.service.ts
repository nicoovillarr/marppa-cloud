...
import { FIBER_REPOSITORY_SYMBOL, FiberRepository } from "../repositories/fiber.repository";
...
export class FiberService {
  ...
  public async findById(zoneId: string, nodeId: string, fiberId: number): Promise<FiberEntity> {
  ...
  public async create(nodeId: string, data: CreateFiberDto): Promise<FiberEntity> {
