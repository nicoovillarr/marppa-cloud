...
import { FiberRepository, FIBER_REPOSITORY_SYMBOL } from '../repositories/fiber.repository';
...
describe('FiberService', () => {
    ...
    describe('findById', () => {
        it('should return a fiber by id', async () => {
            ...
            expect(repository.findById).toHaveBeenCalledWith('z-000001', 'n-000001', 1);
        ...
        it('should throw NotFoundError if fiber not found', async () => {
            ...
            await expect(service.findById('z-000001', 'n-000001', 999)).rejects.toThrow(NotFoundError);
        });
    });
    ...
    describe('findByNodeId', () => {
        it('should return fibers by node id', async () => {
            ...
            expect(repository.findByNodeId).toHaveBeenCalledWith('z-000001', 'n-000001');
            expect(result).toEqual([mockFiberEntity]);
        });
    });
    ...
    describe('create', () => {
        ...
        it('should throw UnauthorizedError if no user in session', async () => {
            ...
            await expect(service.create('n-000001', createDto)).rejects.toThrow(UnauthorizedError);
        });
    });
